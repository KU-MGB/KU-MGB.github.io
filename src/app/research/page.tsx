    ...
    <div className="max-w-7xl mx-auto px-6 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {research.map((item: any) => {
          ...
          return (
            <div key={item.id} className="glass-panel p-12 rounded-[50px] border border-white/5 super-card-hover group relative overflow-hidden flex flex-col">
              ...
              <div className="flex items-start gap-10 relative z-10">
                ...
                <div>
                  ...
                  <div className="prose prose-invert prose-sm text-slate-500 font-medium leading-loose border-t border-white/5 pt-8 italic group-hover:text-slate-400 transition-colors">
                    {item.content}
                  </div>
                </div>
              </div>
      ...
      <section className="mt-40 py-24 glass-panel rounded-[60px] border border-white/10 px-12 relative overflow-hidden">

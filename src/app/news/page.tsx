...
export default function NewsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20">
      <h1 className="text-5xl font-bold text-foreground mb-4">Lab News</h1>
      ...
      <div className="space-y-12">
        {news.map((item: any) => (
          <div key={item.id} className="relative pl-8 border-l border-slate-200 dark:border-white/10 group">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
              {item.title}
            </h2>
